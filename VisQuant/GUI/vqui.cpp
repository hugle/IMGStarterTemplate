...
void VisQuantGui::Init(GLFWwindow* window, const char* glsl_version) {
	IMGUI_CHECKVERSION();
	ImGui::CreateContext();
...
void VisQuantGui::Update() {
	ImGui::Begin("Conan logo");
	render_conan_logo();
	ImGui::End();
}

void VisQuantGui::Render() {
	// Render dear imgui into screen
	ImGui::Render();
	ImGui_ImplOpenGL3_RenderDrawData(ImGui::GetDrawData());
}

void VisQuantGui::ShutDown() {
	// Cleanup
